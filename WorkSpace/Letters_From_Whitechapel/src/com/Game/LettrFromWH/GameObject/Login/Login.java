...
public class Login extends GameObject {
	...
	private boolean questionHaveAccount() {
	...
	private boolean reInputNickname(String nonExistNickname) {
	...
	private boolean checkAccount(String userNickname) {
	...
	// 닉네임 주면 유저 id 반환
	private void settingUserId(String userNickname) {
	...
	private boolean createAccount(String preTalk) {
	...
	// 계정 생성
	private void createAccountDB(String nickName) {
